...
export let RoughneckCrossbowman = new CBTroopType("Company Crossbowman",
    ...
    [
        "./../images/units/mercenaries/unit3L4.png",
        "./../images/units/mercenaries/unit3L4b.png",
        "./../images/units/mercenaries/unit3L3.png",
        "./../images/units/mercenaries/unit3L3b.png",
...
).setMoveProfile(5, new PedestrianMoveProfile(CBProfileCapacity.DISADVANTAGED)
).setMoveProfile(6, new PedestrianMoveProfile(CBProfileCapacity.DISADVANTAGED)
).setMoveProfile(7, new PedestrianMoveProfile(CBProfileCapacity.DISADVANTAGED)
).setMoveProfile(8, new PedestrianMoveProfile(CBProfileCapacity.DISADVANTAGED)
...
).setWeaponProfile(5, new CrossbowWeaponProfile(CBProfileCapacity.ADVANTAGED, 0, 1, 2)
).setWeaponProfile(6, new CrossbowWeaponProfile(CBProfileCapacity.ADVANTAGED, 0, 1, 2)
).setWeaponProfile(7, new CrossbowWeaponProfile(CBProfileCapacity.ADVANTAGED, 0, 1, 3)
).setWeaponProfile(8, new CrossbowWeaponProfile(CBProfileCapacity.ADVANTAGED, 0, 1, 3)
