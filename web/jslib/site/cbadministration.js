    ...
    _setPage(pageIndex) {
        ...
        this._loadPage(pageIndex, this._search, pageData=> {
            ...
            let pageSummary = new Span()
                .addClass("user-pager")
                .setText(String.format(CBUserList.SUMMARY, pageData.userCount, pageData.firstUser, pageData.lastUser));
            let summary = new Div()
...
export class CBUserListPage extends Vitamin(Div) {
    ...
    constructor({loadPage, createUser, updateUser, deleteUser}) {
        ...
        this._search = new VSearch({ref: "user-list-search", searchAction:search=>{
                this.loadUsers();
            }
        });
