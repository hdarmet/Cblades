...
public class PostgreSQLFTSFunction implements SQLFunction {
    ...
    public String render(Type firstArgumentType, List args, SessionFactoryImplementor factory) throws QueryException {
        ...
        if (args.size() > 2) {
            ...
            fragment = "to_tsvector(" + ftsConfiguration + ", translate(" + field + ",'@.,;#','     ')) @@ " + "plainto_tsquery(" + ftsConfiguration + ", " + value + ")";
        } else {
            field = (String) args.get(0);
            value = (String) args.get(1);
            fragment = "to_tsvector(translate(" + field + ",'@.,;#','     ')) @@ " + "plainto_tsquery(" + value + ")";
        }
        return fragment;
    }
