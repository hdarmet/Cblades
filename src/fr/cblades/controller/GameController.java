				...
				.each("players", pJson -> verify(pJson)
					...
					.each("wings", wJson -> verify(wJson)
						...
						.each("units", uJson -> verify(uJson)
							...
							.checkRequired("engaging").checkBoolean("engaging")
							.checkRequired("contact").checkBoolean("contact")
							.checkRequired("orderGiven").checkBoolean("orderGiven")
							.checkRequired("disruptChecked").checkBoolean("disruptChecked")
							.checkRequired("routChecked").checkBoolean("routChecked")
							.checkRequired("neighborsCohesionLoss").checkBoolean("neighborsCohesionLoss")
							.checkRequired("defenderEngagementChecking").checkBoolean("defenderEngagementChecking")
							.checkRequired("attackerEngagementChecking").checkBoolean("attackerEngagementChecking")
							.checkRequired("firstAttack").checkBoolean("firstAttack")
							.checkRequired("secondAttack").checkBoolean("secondAttack")
							.checkRequired("played").checkBoolean("played")
						)
						.checkRequired("moral").checkInteger("moral").checkMin("moral", 4).checkMin("tiredness", 12)
						.checkRequired("tiredness").checkInteger("tiredness").checkMin("tiredness", 4).checkMin("tiredness", 12)
